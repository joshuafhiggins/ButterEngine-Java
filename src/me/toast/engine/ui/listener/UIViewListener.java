...
package me.toast.engine.ui.listener;
...
import me.toast.engine.ui.input.CursorAdapter;
 ...
 */
public class UIViewListener implements UltralightViewListener {
    private final CursorAdapter cursorManager;

    /**
     * Constructs a new {@link UIViewListener} and used the given cursor manager for changing the displayed
     * cursor.
     *
     * @param cursorManager The cursor manager to use for changing the displayed cursor.
     */
    public UIViewListener(CursorAdapter cursorManager) {
